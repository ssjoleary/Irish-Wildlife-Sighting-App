...
public class ImgurAuthorization {
    ...
    public boolean isLoggedIn() {
        Context context = SubmitActivity.getAppContext();
    ...
    public void addToHttpURLConnection(HttpURLConnection conn) {
        ...
        if (!TextUtils.isEmpty(accessToken)) {
            ...
            conn.setRequestProperty("Authorization", "Client-ID " + LocationUtils.MY_IMGUR_CLIENT_ID);
        }
    }
    ...
    public String requestNewAccessToken() {
        ...
        try {
            ...
            nvps.add(new BasicNameValuePair("client_id", LocationUtils.MY_IMGUR_CLIENT_ID));
            nvps.add(new BasicNameValuePair("client_secret", LocationUtils.MY_IMGUR_CLIENT_SECRET));
